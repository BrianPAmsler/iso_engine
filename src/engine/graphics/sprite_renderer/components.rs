...
use gl_types::{vec2, vectors::Vec2};
use image::ImageError;
use itertools::Itertools;

use crate::{engine::{Engine, game_object::{ObjectID, component::Component}, graphics::sprite_renderer::{AnimatedSpriteID, SpriteDefinition, SpriteSheetID, animated_sprite::AnimatedSpriteData}}, error::{ExplicitUnwrap, Result, universal_errors::Uninitialized}};
...
impl Component for AnimatedSprite {
    ...
    fn update(&mut self, engine: &mut Engine, owner: ObjectID, delta_time: f32) -> crate::error::dyn_error::Result<()> {
