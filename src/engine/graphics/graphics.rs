...
use crate::{engine::{data_structures::{AllocationIndex, VecAllocator}, graphics::{error::{BufferImageError, DescriptorSetError, DrawError, GetBindingError, GetCommandBuffersError, GetFramebuffersError, GetPipelineError, InvalidBinding, InvalidEntryPoint, InvalidPipelineHandle, NewGraphicsError, NoLayout, NoPhysicalDevices, SRGBUnsupported, SetIndirectBufferError, UpdatePipelinesError}, texture::Texture}}, error::{ExplicitUnwrap, Result}};
...
pub mod pipeline_builder {
    ...
    mod stage_4 {
        ...
        use crate::{engine::graphics::{Binding, BufferType, Graphics, PipelineHandle, error::PipelineBuilderError, graphics::{PipelineCell, get_descriptor_set, get_pipeline}, texture::Texture}, error::Result};
